...
<script>
        ...
        var tabela = $('#tb_pedido').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    defaultContent: "",
                    render: function (data, type, row) {
                        return row.dados_produto.toLocaleString("pt-BR", { style: "currency", currency: "BRL" });
                    }
                },
                {
                    data: null,
    ...
    function criaDadosProduto(_this) {
        var html = "";
            ...
            html += `<h5 class="card-title">Copinho sla</h5>`
            html += `<div>`
            html += `<label for="qtdPrd">QTD</label>`
            html += `<input id="qtdPrd" name="qtdPrd[]" onKeyUp="maskIt(this,event,'#########.##',true)" type="text" value="10" class="form-control" {$dados.dados_produto} />`
            html += `</div>`
            html += `</div>`
            html += `</div>`
            html += `</div>`
...
<div class="main-cadastro-produto">
    <form class="row g-4">
        ...
        <div class="col-md-3">
            ...
            <select class="form-select" aria-label="Default select example" onchange="criaDadosProduto(this.value)" id="produto">
                <option value="">Selecione</option>
            </select>
        </div>
        <div class="row">
            <div id="addList" class="col-12 mt-1 ">
            </div>
        </div>
        <div class='row mt-3'>
                ...
                <div class="card mb-3 shadow p-3 mb-5 bg-body rounded" style="max-width: 540px;">
                    ...
                    <div class="row g-0">
                        <div class="col-md-4 d-flex justify-content-center align-items-center">
                            <img src='data:image/jpeg;base64,'
                                class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8" style="height: 150px">
                            <div class="card-body">
                                <h5 class="card-title">Copinho sla</h5>
                                <div>
                                    <label for="qtdPrd">QTD</label>
                                    <input id="qtdPrd" name="qtdPrd[]" onKeyUp="maskIt(this,event,'#########.##',true)"
                                        type="text" value="10" class="form-control" />
                                </div>
