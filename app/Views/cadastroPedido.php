...
<div class="main-cadastro-produto">
    <form class="row g-4">
        ...
        <div class="col-md-3">
            ...
            <input type="text" class="form-control" id="dados_produto" onKeyUp="maskIt(this,event,'#########.##',true)">
        </div>
        <div class='row mt-3' >
                        ...
                        <div class="col-md-8" style="height: 150px" >
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <input id="qtdPrd" name="qtdPrd[]" onKeyUp="maskIt(this,event,'#########.##',true)" type="text" value="10" class="form-control" />
                                </div>
